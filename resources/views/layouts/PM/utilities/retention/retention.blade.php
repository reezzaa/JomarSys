 ...
 <div>
   {!! Form::open(['url'=>'pmretention', 'method'=>'POST', 'id'=>'frm-insert']) !!}
                      <div class="col-md-12">
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="block">
              ...
              {!! Form::open(['url'=>'{{ route(pm.utilities.retention)}}','method'=>'PUT','id'=>'frm-upd']) !!}
              <div class="form-group">
      ...
      <div class="modal-content">
        <div class="block">
         <div class="block-title themed-background">
           ...
           {!!Form::open(['url'=>'{{ route(pm.utilities.retention.del)}}','method'=>'PUT','id'=>'frm-del'])!!}
