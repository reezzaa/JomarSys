 ...
 <div>
   {!! Form::open(['url'=>'pmfee', 'method'=>'POST', 'id'=>'frm-insert']) !!}
                      <div class="col-md-5">
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="block">
              ...
              {!! Form::open(['url'=>'{{ route(pm.utilities.fee)}}','method'=>'PUT','id'=>'frm-upd']) !!}
              <div class="form-group">
      ...
      <div class="modal-content">
        <div class="block">
         <div class="block-title themed-background">
           ...
           {!!Form::open(['url'=>'{{ route(pm.utilities.fee.del)}}','method'=>'PUT','id'=>'frm-del'])!!}
