         <div class="block">
            ...
            @empty
              {!! Form::open(['action'=>'PM\UtilitiesController@storeEmpID', 'id'=>'save-empNoSC','class'=>'form-horizontal form-bordered', 'method'=>'POST']) !!}
            ...
            @empty
                {!! Form::open(['action'=>'PM\UtilitiesController@storeClientID', 'id'=>'save-clientNoSC','class'=>'form-horizontal form-bordered', 'method'=>'POST']) !!}
                    <div class="form-group">
            ...
            @empty
                {!! Form::open(['action'=>'PM\UtilitiesController@storeContractID', 'id'=>'save-contractNoSC','class'=>'form-horizontal form-bordered', 'method'=>'POST']) !!}
                    <div class="form-group">
            ...
            @empty
                {!! Form::open(['action'=>'PM\UtilitiesController@storeInvoiceID', 'id'=>'save-invoiceNoSC','class'=>'form-horizontal form-bordered', 'method'=>'POST']) !!}
                    <div class="form-group">
            ...
            @empty
                {!! Form::open(['action'=>'PM\UtilitiesController@storeOrID', 'id'=>'save-orNoSC','class'=>'form-horizontal form-bordered', 'method'=>'POST']) !!}
                    <div class="form-group">
