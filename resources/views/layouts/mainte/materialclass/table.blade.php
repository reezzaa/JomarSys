<table id="matClass-datatable" class="table table-vcenter table-striped table-condensed table-bordered table-hover">
  <thead>
   ...
   <tbody id="matclass-list">
    @foreach($matclass as $key => $u)
    <tr id="id{{$u->intMatClassID}}">
          ...
          <label class="switch switch-primary">
            @if(($u->status)==1)
              ...
              @else
                  <p hidden>0</p> 
              @endif
            <input name="status" id="status" type="checkbox" value="{{ $u->intMatClassID }}" 
              @if(($u->status)==1)
                  {{"checked"}}
              @else
                  {{""}} 
        ...
        <td>
          <div class="text-center">
            <button id="edit_supp" class="btn btn-alt btn-warning edit_supp" value = "{{$u->intMatClassID}}" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><span class="gi gi-pencil"></span>
            </button>
            <button id="del_supp" class="btn btn-alt btn-danger del_supp" value="{{$u->intMatClassID}}" data-toggle="tooltip" data-placement="top" data-original-title="Delete"> <span class="gi gi-bin"></span>
            </button>
          </div>
        </td>
    </tr>
        ...
        <div class="modal-content">
          <div class="block">
             <div class="block-title themed-background">
              ...
              {!! Form::open(['url'=>'materialclass','method'=>'PUT','id'=>'frm-upd']) !!}
                <div class="form-group">
                  <label for="mattypes">Material Type <span class="text-danger">*</span> </label>
                  {!! Form::select('mattypes', $mattype, null,  ['id'=>'mattypes','class'=>'form-control', 'placeholder'=>'']) !!}
                ...
                <div class="form-group">
                  ...
                  {!!Form::text('strMaterialClassname' , null,['id'=>'strMaterialClassname', 'class'=>'form-control', 'maxLength'=>'30'])!!}
        ...
        <div class="modal-content">
          <div class="block">
            <div class="block-title themed-background">
             ...
             {!!Form::open(['url'=>'materialclass','method'=>'PUT','id'=>'frm-del'])!!}
