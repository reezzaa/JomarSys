                ...
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                      <div class="block">
                        ...
                        <div class="form-group">
                          <label for="equipmake">Make/Brand </label> <span class="text-danger">*</span> 
                          {!! Form::text('equipmake',null ,['id'=>'equipmake','placeholder'=>'Make', 'class' => 'form-control', 'maxlength'=>'30']) !!}
                        ...
                        <div class="form-group">
                          <label for="equipweight">Operating Weight</label> <span class="text-danger">*</span> 
