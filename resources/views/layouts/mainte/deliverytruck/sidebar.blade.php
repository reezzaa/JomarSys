<ul class="sidebar-nav">
    ...
    <li >
        <a href="{{ route('utilities.index') }}" class="active"><i class="fa fa-cogs sidebar-nav-icon"></i>Utilities</a>
    </li>
    <li>
    ...
    <li  >
        ...
        <ul>
            ...
            <li>
                <a class="sidebar-nav-submenu" href="{{ route('progressmonitoring.index')}}" "><i class="fa fa-angle-left sidebar-nav-indicator"></i>
                <i class="fa fa-signal sidebar-nav-icon"></i>Progress Monitoring</a>
                <ul>
                    <li>
                        <a href="{{ route('indprogressmonitoring.index')}}"> Individual Client</a>
                    </li>
                    <li>
                        <a  href="{{ route('progressmonitoring.index')}}"> Company Client</a>
                    </li>
                </ul>
            </li>
            <li>
    ...
    <li>
        ...
        <ul>
            <li>
                <a  href="{{ route('clientqueries.index')}}" class="active">
            ...
            <li>
                <a href="{{ route('stockqueries.index')}}">
                <i class="fa fa-cubes sidebar-nav-icon"></i>Stock Adjustment</a>
            </li>
            <li>
                <a href="{{ route('invoicequeries.index')}}">
               <i class="gi gi-tags sidebar-nav-icon"></i> Invoices</a>
            </li>
            <li>
                <a  href="{{ route('deliveryqueries.index')}}"><i class="gi gi-group sidebar-nav-icon"></i> Delivery</a>
            </li>
        </ul>
    </li>   
    <li>
