    ...
    <div class="sidebar-scroll">
        ...
        <div class="sidebar-content">
             <!-- Icon for user -->
              ...
              <!-- Sidebar Navigation -->
              @include('layouts.mainte.employee.sidebar')
...
@section('content')
  ...
  <div class="block">
    ...
    {!! Form::open(['url'=>'addworker', 'method'=>'POST', 'id'=>'form-validation', 'class' => 'form-horizontal form-bordered']) !!}
    @include('layouts.mainte.employee.form')
    {!! Form::close() !!}
