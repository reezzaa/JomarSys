...
<div id="sidebar">
    ...
    <div class="sidebar-scroll">
        ...
        <div class="sidebar-content">
          ...
          <!-- @include('layouts.mainte.UOM.sbgroup') -->
              ...
              <div class="modal-content">
                  <div class="block">
                    <div class="block-title themed-background">
                     ...
                     {!! Form::open(['url'=>'groupuomeasure', 'method'=>'POST', 'id'=>'frm-insert']) !!}
                      <div class="form-group">
                        <label for="groupuomname">
                        Based UOM Name
                        <span class="text-danger">*</span> 
                        </label>
                        {!! Form::text('groupuomname',null ,['id'=>'groupuomname','placeholder'=>'Based UOM Name', 'class' => 'form-control', 'maxlength'=>'40'])
                        !!}
