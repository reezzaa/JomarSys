          ...
          <div class="block">
             <div class="block-title themed-background">
              ...
              {!! Form::open(['url'=>'materialclass','method'=>'PUT','id'=>'frm-upd']) !!}
                ...
                <div class="form-group">
                  <label for="MaterialClassname">Material Classification Name <span class="text-danger">*</span> </label>
                  {!!Form::text('MaterialClassname' , null,['id'=>'MaterialClassname', 'class'=>'form-control', 'maxLength'=>'30'])!!}
                  <span id="duplicates2" class="help-block animation-slideDown">
                  Duplicate Material Classification Name
                  </span>
                  <script>
                      $('#MaterialClassname').alphanum({
