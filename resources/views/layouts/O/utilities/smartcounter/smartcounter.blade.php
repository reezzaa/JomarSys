         <div class="block">
            ...
            @empty
                {!! Form::open(['action'=>'O\UtilitiesController@storeContractID', 'id'=>'save-contractNoSC','class'=>'form-horizontal form-bordered', 'method'=>'POST']) !!}
                    <div class="form-group">
            ...
            @empty
                {!! Form::open(['action'=>'O\UtilitiesController@storeInvoiceID', 'id'=>'save-invoiceNoSC','class'=>'form-horizontal form-bordered', 'method'=>'POST']) !!}
                    <div class="form-group">
            ...
            @empty
                {!! Form::open(['action'=>'O\UtilitiesController@storeOrID', 'id'=>'save-orNoSC','class'=>'form-horizontal form-bordered', 'method'=>'POST']) !!}
                    <div class="form-group">
