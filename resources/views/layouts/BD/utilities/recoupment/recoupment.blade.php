 ...
 <div>
   {!! Form::open(['url'=>'bdrecoupment', 'method'=>'POST', 'id'=>'frm-insert']) !!}
                      <div class="col-md-12">
                          <div class="form-group">
                          <label for="recoupment" class="col-md-3">Recoupment Value <span class="text-danger">*</span></label> 
                         <div class="col-md-7">
                            {!! Form::text('recoupment', null,  ['id'=>'recoupment','class'=>'form-control', 'placeholder'=>'e.g 99999, etc.']) !!}
                         </div>
        ...
        <div class="modal-content">
          <div class="block">
              <div class="block-title themed-background">
                ...
                <h3 class="themed-background" style="color:white;"><strong>Edit Recoupment</strong></h3>
              </div>

              {!! Form::open(['url'=>'{{ route(bd.utilities.recoupment)}}','method'=>'PUT','id'=>'frm-upd']) !!}
              <div class="form-group">
                 <label for="recoupments">Recoupment Value</label> 
                 <span class="text-danger">*</span> 
                  {!! Form::text('recoupments', null,  ['id'=>'recoupments','class'=>'form-control', 'placeholder'=>'e.g 99999, etc.']) !!}
                  <span id="duplicate1" class="help-block animation-slideDown">
      ...
      <div class="modal-content">
        <div class="block">
         <div class="block-title themed-background">
           ...
           {!!Form::open(['url'=>'{{ route(bd.utilities.recoupment.del)}}','method'=>'PUT','id'=>'frm-del'])!!}
        ...
        if($('#recoupment').val() != "")
        {
                          ...
                          $.ajax({
                            ...
                            success:function(data){
                              readByAjax();
                              $(".modal").modal('hide');
                              swal("Success","Recoupment Added!", "success");
                            },
                            error:function(data){
                              /////////////////stop top loading//////////
                              NProgress.done();
                              ///////////////////////////////////////////
                               $('span#duplicate1').text("Duplicate Recoupment Value!");
...
//get edit data
      $(this).on('click','.edit_supp', function(){
          ...
          $.get(url + '/' + classID + '/edit', function (data) {
                $('#recoupments').val(data.RecValue);
                selfName = $('#recoupments').val();
      ...
      $(this).on('submit' ,function(e){
         ...
         $('span#duplicates1').hide();
          ...
          if($('#recoupments').val() != "")
        {                       
                          if(selfName == $('#recoupments').val())
                          {
                            swal("Info", "Same Recoupment Value", "info");
                          }
                          else
                          { 
                            /////////////////start top loading//////////
                            ...
                            $.ajax({
                              ...
                              success:function(data){
                                readByAjax();
                                $(".modal").modal('hide');
                                swal("Success","Recoupment Edited!", "success");
                              },
                              error:function(data){
                                  /////////////////stop top loading//////////
                                  NProgress.done();
                                  ///////////////////////////////////////////
                                 $('span#duplicates1').text("Duplicate Recoupment Description");
    ...
    //status listen edit
     ...
     $(this).on('click','#del_supp', function(){
      ...
      $.get(url + '/' + classe + '/edit', function (data) {
            ...
            $('#del_classname').text(data.RecValue);
