      ...
      ///////////////////////////////////////////
        $.ajax({
          ...
          success:function(data)
          {
              ...
              $('#title').html('<strong>Payment Form</strong>');
          }
        })
         /////////////////stop top loading//////////
          NProgress.done();
 ...
 <div>
   {!! Form::open(['url'=>'bdpaymentform', 'method'=>'POST', 'id'=>'frm-insert']) !!}
                      <div class="col-md-12">
                         ...
                         <div class="col-md-9">
                            {!! Form::text('paymentform', null,  ['id'=>'paymentform','class'=>'form-control', 'placeholder'=>'e.g Cash, etc.']) !!}
                         </div>
                          <span id="duplicate1" class="help-block animation-slideDown">
                              Duplicate Material Name
                          </span>
                          <script>
                              $('#paymentform').alphanum({
          ...
          <div class="block">
              ...
              <div class="form-group">
                 ...
                 <span class="text-danger">*</span> 
                  {!! Form::text('paymentforms', null,  ['id'=>'paymentforms','class'=>'form-control', 'placeholder'=>'e.g Cash, etc.']) !!}
                  <span id="duplicate1" class="help-block animation-slideDown">
                  Duplicate Material Classification Name
                  </span>
                   <script>
                    $('#paymentforms').alphanum({
                     allow :    '-,.()/', // Specify characters to allow
                   });
                </script>
              </div>
        ...
        if($('#paymentform').val() != "")
        {
                          ...
                          $.ajax({
                            ...
                            success:function(data){
                              readByAjax();
                              $(".modal").modal('hide');
                              swal("Success","Form of Payment Added!", "success");
                            },
                            error:function(data){
                              /////////////////stop top loading//////////
                              NProgress.done();
                              ///////////////////////////////////////////
                               $('span#duplicate1').text("Duplicate Form of Payment Description!");
...
//get edit data
      $(this).on('click','.edit_supp', function(){
          ...
          $.get(url + '/' + classID + '/edit', function (data) {
                $('#paymentforms').val(data.FormDesc);
                selfName = $('#paymentforms').val();
      ...
      $(this).on('submit' ,function(e){
         ...
         $('span#duplicates1').hide();
          ...
          if($('#paymentforms').val() != "")
        {                       
                          if(selfName == $('#paymentforms').val())
                          {
                            swal("Info", "Same Form of Payment Information", "info");
                          }
                          else
                          { 
                            /////////////////start top loading//////////
                            ...
                            $.ajax({
                              ...
                              success:function(data){
                                readByAjax();
                                $(".modal").modal('hide');
                                swal("Success","Form of Payment Edited!", "success");
                              },
                              error:function(data){
                                  /////////////////stop top loading//////////
                                  NProgress.done();
                                  ///////////////////////////////////////////
                                 $('span#duplicates1').text("Duplicate Form of Payment Name");
    ...
    //status listen edit
     ...
     $(this).on('click','#del_supp', function(){
      ...
      $.get(url + '/' + classe + '/edit', function (data) {
            ...
            $('#del_classname').text(data.FormDesc);
