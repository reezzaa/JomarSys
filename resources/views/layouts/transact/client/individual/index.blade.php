  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
              ...
              <!-- @include('layouts.transact.client.individual.sidebar') -->
...
@section('content')
      ...
      <div class="block">
          @include('layouts.transact.client.individual.table')
          <br>
      </div>
@endsection
@section('script')
<a class="float" href="{{ url('newindclient/create') }}" data-toggle="tooltip" data-placement="left" title="Add Individual Client">
