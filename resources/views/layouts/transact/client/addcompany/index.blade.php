  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
              ...
              <!-- @include('layouts.transact.client.addcompany.sidebar') -->
...
@section('content')
      ...
      <ol class="breadcrumb breadcrumb-top">
        ...
        <div class="block">
          ...
          {!! Form::open(['url'=>'newcompclient', 'id'=>'save-client','class'=>'form-horizontal form-bordered', 'files' => true]) !!}
              @include('layouts.transact.client.addcompany.form')
...
{!! JsValidator::formRequest('App\Http\Requests\CreateCompClientRequest', '#save-client'); !!}
@endsection