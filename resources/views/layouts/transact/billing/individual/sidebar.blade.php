    ...
    <li class="active" >
        ...
        <ul>
            ...
            <li>
             ...
             <li class="active">
                <a class="sidebar-nav-submenu active" href="{{ route('billing.index')}}"><i class="fa fa-angle-left sidebar-nav-indicator"></i><i class="gi gi-tags sidebar-nav-icon"></i>Billing and Collection</a>
                <ul>
                    <li>
                        <a href="{{ route('individualbilling.index')}}" class="active"> Individual Client</a>
                    </li>
                    <li>
