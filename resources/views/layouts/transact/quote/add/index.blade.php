    ...
    <div class="col-md-9">
      <div class="block">
        ...
        <div class="block">
          ...
          {!! Form::open(['url'=>'quote', 'id'=>'save-quote','class'=>'form-horizontal']) !!}
            ...
            <div class="form-group">
              <div class="col-md-offset-9">
                 {!! Form::submit('Save Description',['id'=>'submithead','class'=>'btn btn-alt btn-success']) !!}
              </div>
            </div>
          {!! Form::close() !!}
...
<!--           {!! Form::open(['url'=>'addquotation', 'method'=>'POST', 'id'=>'save-quotation']) !!}
          {!! Form::submit('Finalize Quote',['id'=>'addservice','class'=>'btn btn-info']) !!}
          {!! Form::close() !!} -->
        </div>
        <div class="clearfix"></div>
      </div>
