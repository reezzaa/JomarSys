...
@foreach($quoteD as $quoteD)
<ol class="breadcrumb breadcrumb-top">
  <li><a href="{{ route('dashboard') }}"><i class="fa fa-home"></i></a></li>
  <li><a href="javascript:void(0)">Transaction</a></li>
  <li><a href="javascript:void(0)">Quote</a></li>
  <li><a href="/quotedetail/{{ $quoteD->strQHID }}">Add Quote</a></li>
    ...
    <div class="block-section">
      <!-- Quote Info -->
          <div class="col-md-offset-1">
            <h5><strong>Quotation ID:</strong> {{ $quoteD->strQHID }}</h5>
            <i id="putQDID" class="hidden">{{ $quoteD->intQDID }}</i>
          </div>
          <div class="col-md-offset-1">
            <h5><strong>Service Name:</strong> {{ $quoteD->strServiceOffName }}</h5>
          </div>
          <hr>
                          ...
                          <div class="form-group">
                            <div>
                              ...
                              <select id="materialClass" name="materialClass" onchange="findMatbyClass(this.value)" style="width: 250px;" class="select-chosen" data-placeholder="Filter by Classification">
                                ...
                                <option value="{{ $materialClass->intMatClassID }}">{{ $materialClass->strMatClassName }}
                                </option>
                                @endforeach
                              </select>
                            </div>
                          ...
                          <div class="form-group">
                            <div>
                              ...
                              <select id="uom" name="uom" onchange="findMatbyUOM(this.value)" style="width: 250px;" class="select-chosen" data-placeholder="Filter by UOM">
                                ...
                                <option value=""></option>
                                @foreach($uom as $uom)
                                <option value="{{ $uom->intDetailUOMID }}">{{ $uom->strDetailUOMText }}
                                </option>
                                @endforeach
                              </select>
                            </div>
                          ...
                          <div class="form-group">
                            <div>
                              ...
                              <select id="material" name="material" onchange="findPrice(this.value)" style="width: 250px;" class="select-chosen" data-placeholder="Select Material">
                                ...
                                <option value="{{ $material->intMaterialID }}">{{ $material->strMaterialName }}
                                </option>
                                @endforeach
                              </select>
                            </div>
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  <div class="block">
                    ...
                    {!! Form::open(['url'=>'addequipment', 'method'=>'POST', 'id'=>'save-equipment']) !!}
                      <div class="row">
                        <div class="col-md-6 col-md-offset-1">
                          <div class="form-group">
                            <div>
                              ...
                              <select id="equipname" name="equipname" onchange="find(this.value)" style="width: 250px;" class="select-chosen" data-placeholder="Select Material">
                                ...
                                <option value="{{ $equip->intEquipID }}">{{ $equip->strEquipName }}
                                </option>
                                @endforeach
                              </select>
                            </div>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <div>
                              ...
                              {!! Form::text('text',null ,['id'=>'equipprice','placeholder'=>'0', 'class' => 'form-control', 'maxlength'=>'30','onchange'=>'compute2(this.value)']) !!}
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-4 col-md-offset-2">
                          <div class="form-group">
                            <div>
                              ...
                              {!! Form::text('number',null ,['id'=>'equipqty','placeholder'=>'Qty', 'class' => 'form-control', 'maxlength'=>'30','onchange'=>'compute2(this.value)']) !!}
                            </div>
                          </div>
                        </div>
                         <div class="col-md-4">
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  <div class="block">
                    ...
                    {!! Form::open(['url'=>'addworker', 'method'=>'POST', 'id'=>'save-worker']) !!}
                      <div class="row">
                          ...
                          <div class="form-group">
                            <div>
                              ...
                              <select id="specname" name="specname" style="width: 250px;" class="select-chosen" data-placeholder="Select Material">
                                ...
                                <option value="{{ $spec->intSpecID }}">{{ $spec->strSpecDesc }}
                                </option>
                                @endforeach
                              </select>
                            </div>
                        ...
                        <div class="col-md-5 col-md-offset-1">
                          <div class="form-group">
                            <div>
                              ...
                              {!! Form::text('number',null ,['id'=>'rate','placeholder'=>'0', 'class' => 'form-control', 'maxlength'=>'30','onchange'=>'compute3(this.value)']) !!}
                            </div>
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            <div>
                              ...
                              {!! Form::text('number',null ,['id'=>'hour','placeholder'=>'0', 'class' => 'form-control', 'maxlength'=>'30','onchange'=>'compute3(this.value)']) !!}
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-4 col-md-offset-2">
                          <div class="form-group">
                            <div>
                              ...
                              {!! Form::text('number',null ,['id'=>'workerqty','placeholder'=>'Qty', 'class' => 'form-control', 'maxlength'=>'30','onchange'=>'compute3(this.value)']) !!}
                            </div>
                          </div>
                        </div>
                         <div class="col-md-4">
