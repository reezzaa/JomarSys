...
@foreach($indquote as $indquote)
  <div class="block full">
    <div class="block-title themed-background">
      <div class="block-options pull-right">
          <a href="" class="btn btn-sm btn-alt btn-primary" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
      </div>
    <h3 class="themed-background" style="color:white;"><strong>Quotation #: <span id="quoteNo">{{ $indquote->strQuoteID }}</span></strong></h3>
    </div>
   <div class="block-section">
      <!-- Company Info -->
          <div class="col-md-offset-1">
            <h5><strong>Client ID: {{ $indquote->strIndClientID }}</strong></h5>
          </div>
          <div class="col-md-offset-1">
            <h5><strong>Client Name: {{ $indquote->strIndClientFName }} {{ $indquote->strIndClientMName }} {{ $indquote->strIndClientLName }}</strong></h5>
          </div>
          <div class="col-md-offset-1">
            @if($indquote->strQuoteName != "")
              <h5><strong>Quote Description: {{ $indquote->strQuoteName }}</strong></h5>
            @else
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="block-title themed-background">
              ...
              <h3 class="themed-background" style="color:white;"><strong>Finalize {{ $indquote->strQuoteID }}</strong></h3>
           </div>
              {!! Form::open(['url'=>'addquotation', 'method'=>'POST', 'id'=>'form-validation']) !!}
              @include('layouts.transact.quote.add.draft.form2')
              ...
              <input type="hidden" name="id" id="id" value="{{ $indquote->strQuoteID }}">
    ...
    <div class="modal-content">
        <div class="block">
          ...
          {!! Form::open(['url'=>'additional', 'id'=>'save-additional','class'=>'form-horizontal']) !!}
            ...
            <div class="form-group">
              <div class="col-md-offset-9">
              <input type="hidden" name="qdid" value="{{ $indquote->strQuoteID }}">
