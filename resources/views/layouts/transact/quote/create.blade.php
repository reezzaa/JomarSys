              ...
              <div class="block">
                <div class="block-title themed-background">
                  <div class="block-options pull-right">
                      <h2 style="color:white;"><strong>Quote #: <span id="quoteNo"> {{ $quote1->intQuoteID }}</span></strong></h2>
                  </div>
                  <h3 class="themed-background" style="color:white"><strong>Quote Description</strong></h3>
                </div>
                <div class="tab-content">
                  <div class="tab-pane active" id="qh" role="tabpanel">
                     {!! Form::model($quote1, ['method'=>'PATCH', 'action'=>['QuoteController@update', $quote1->strQuoteID],'id'=>'update','class'=>'form-horizontal form-bordered']) !!}
        ...
        <div class="form-group">
            <div class="col-md-3">
              <div class="block">
                ...
                <ul class="nav nav-pills nav-stacked" id="myTab" role="tablist">
                    <li class="nav-item active"><a class="nav-link active" data-toggle="tab" href="#qh" role="tab"><strong>Quote Description</strong></a></li>
                    <li class="nav-item disabled"><a class="nav-link" data-toggle="tab" href="#qd" role="tab"><strong>Quote Detail</strong></a></li>
                </ul>
                <br><br>
              </div>
            </div>
            <div class="col-md-9">
              <div class="block">
                <div class="block-title themed-background">
                  <div class="block-options pull-right">
                      <h2 style="color:white;"><strong>Quote #: <span id="quoteNo"></span></strong></h2>
                  </div>
                  <h3 class="themed-background" style="color:white"><strong>Quote Description</strong></h3>
                </div>
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="qd" role="tabpanel">Add Quote Header First!</div>
                </div>
                <div class="clearfix"></div>
                <br>
              </div>
        ...
        var ddata = {
          ...
          $.ajax({
              ...
              success:function(data){
                ...
                $('#strQuoteName').attr('readonly','readonly');
                $('#quoteNo').text(data);
