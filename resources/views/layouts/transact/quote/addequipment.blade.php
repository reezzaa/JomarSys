...
@section('content')
      ...
      <ol class="breadcrumb breadcrumb-top">
          ...
          <li><a href="javascript:void(0)">Add Equipment</a></li>
      </ol>
        <div class="block">
          <div class="block-title themed-background">
          @foreach($qdids as $qhids)
          <h3 class="themed-background" style="color:white;"><strong>Add Equipment to Quote # {{$qhids->intQHID}}</strong></h3>
          @endforeach
          </div>
          {!! Form::open(['url'=>'addequipment', 'id'=>'save-equipment','class'=>'form-horizontal form-bordered']) !!}
            <div class="form-group">
				<div>
					<div class="col-md-5 col-md-offset-2">
				      <div class="form-group">
			           	{!! Form::label('equipment','Equipment Name',array('class'=>'label_ttl')) !!}
						  <select id="equipment"  name="equipment" style="width: 250px;" class="select-chosen" data-placeholder="Select Equipment">
						  	<option></option>
						  	@foreach($equip as $mat)
						  	<option value="{{ $mat->intEquipID }}">{{ $mat->strEquipName }}
						  	</option>
						  	@endforeach
						  </select>
					  </div>
			...
			<div class="form-group">
			 <div class="col-md-offset-10">
			     {!! Form::submit('Add',['id'=>'addequipment','class'=>'btn btn-alt btn-success']) !!}
			  </div>
			</div>
	        {!! Form::close() !!}
