...
@section('content')
      ...
      <ol class="breadcrumb breadcrumb-top">
          ...
          <li><a href="javascript:void(0)">Add Worker</a></li>
      </ol>
        <div class="block">
          ...
          {!! Form::open(['url'=>'addworker', 'id'=>'save-worker','class'=>'form-horizontal form-bordered']) !!}
            <div class="form-group">
				<div>
					<div class="col-md-5 col-md-offset-2">
				      <div class="form-group">
			           	{!! Form::label('worker','Specialize in:',array('class'=>'label_ttl')) !!}
						  <select id="worker"  name="worker" style="width: 250px;" class="select-chosen" data-placeholder="Select Specialization needed">
						  	<option></option>
						  	@foreach($worker as $mat)
						  	<option value="{{ $mat->intSpecID }}">{{ $mat->strSpecDesc }}
						  	</option>
						  	@endforeach
						  </select>
					  </div>
			...
			<div class="form-group">
			 <div class="col-md-offset-10">
			     {!! Form::submit('Add',['id'=>'addworker','class'=>'btn btn-alt btn-success']) !!}
			  </div>
			</div>
	        {!! Form::close() !!}
