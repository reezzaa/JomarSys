<table id="stock-datatable" class="table table-vcenter table-striped table-bordered table-hover">
  ...
  <tbody>
    ...
    <tr >
      ...
      <td class="text-center">
        {{\Carbon\Carbon::parse($s->dtmStock)->toDayDateTimeString()}}
      </td>
      <td class="text-center">
        <button id="add" class="btn btn-success btn-alt add" value="{{$s->intMaterialID}}" data-toggle="tooltip" data-placement="top" data-original-title="In"> <span class="gi gi-inbox_in"></span> </button>
        <button id="subtract" class="btn btn-danger btn-alt subtract" value="{{$s->intMaterialID}}" data-toggle="tooltip" data-placement="top" data-original-title="Out"> <span class="gi gi-inbox_out"></span> </button>
