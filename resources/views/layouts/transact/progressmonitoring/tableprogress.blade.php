              ...
              <tbody>
				...
				<tr>
                 ...
                 <td class="text-center">
                         ...
                         <button type="button" id="edit_this" value="{{$f->intProgID}}" class="btn btn-warning butun" data-toggle="tooltip" data-placement="top" title="Edit"><i class="gi gi-pen"></i></button> 
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="block full container-fluid">
                ...
                {!! Form::open(['url'=>route('progressmonitoring.storeThis','classID'),'method'=>'POST','id'=>'form-validation']) !!}       
                <br>         
      ...
      <div class="modal-content">
        <div class="block full container-fluid">
            <div class="block-title themed-background">
             ...
             {!!Form::open(['url'=>'progressmonitoring','method'=>'PUT','id'=>'frm-del'])!!}
