<table id="qclient-datatable" class="table table-vcenter table-striped table-bordered table-hover">
  ...
  <tbody id="client-list">
     @foreach($qproj2 as $qproj2)
    <tr>
    <td class="text-center">
        {{$qproj2->strServInvHID}}
      </td>
      <td class="text-center">
        ₱ {{$qproj2->dblServInvDCost}}
      </td>
      <td class="text-center">
      </td>
      <td class="text-center">
        {{\Carbon\Carbon::parse($qproj2->datPaymentDateIssued)->toFormattedDateString()}}
      </td>
      <td class="text-center">
        {{$qproj2->strORNumber}}
      </td>
