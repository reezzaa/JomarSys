...
class PrintContractController extends Controller
{
    ...
    {
         return view('layouts.transaction.contract.print',['contracts'=> Contract::join('tblClient', 'tblContract.intContClientID', '=', 'tblClient.intClientID')
            ->select('tblContract.*','tblClient.strClientName')
            ->orderby('tblContract.intContractID')
