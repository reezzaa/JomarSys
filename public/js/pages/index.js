    ...
    return {
        init: function() {
            ...
            var miniChartBarOptions = {
                ...
                barColor: '#999999',
                tooltipPrefix: '+ ',
                tooltipSuffix: ' Clients',
                tooltipFormat: '{{prefix}}{{value}}{{suffix}}'
            };
            $('#mini-chart-sales').sparkline([6,3,1,5,4,6,7,4,3,7,8,10,6,7], miniChartBarOptions);
            $('#mini-chart-clients').sparkline([6,3,1,5,4,6,7,4,3,7,8,10,6,7], miniChartBarOptions);
            $('#mini-chart-contracts').sparkline([6,3,8,2,5,6,4,6,10,5,2,5,5,9], miniChartBarOptions);
