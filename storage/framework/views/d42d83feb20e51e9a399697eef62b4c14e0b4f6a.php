      ...
      <div class="form-group">
        <div>
          ...
          <div class="col-md-6">
              ...
              <?php $__currentLoopData = $special; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($key->intSpecID); ?>"> <?php echo e($key->strSpecDesc); ?>
