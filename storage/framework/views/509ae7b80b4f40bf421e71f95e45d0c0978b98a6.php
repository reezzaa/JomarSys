  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
              ...
              <!-- <?php echo $__env->make('layouts.mainte.materialclass.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="block">
            ...
            <?php echo Form::open(['url'=>'materialclass', 'method'=>'POST', 'id'=>'frm-insert']); ?>

                <div class="row">
                  <div class="col-md-6 col-md-offset-3">
                    <label for="mattype" class="col-md-offset-4">Material Type</label> <span class="text-danger">*</span>
                    <?php echo Form::select('mattype', $mattype, null,  ['id'=>'mattype','class'=>'form-control', 'placeholder'=>' ']); ?>
                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="form-group">
                      ...
                      <span class="text-danger">*</span> 
                        ...
                        <?php echo Form::text('matclassname',null ,['id'=>'matclassname','placeholder'=>'Material Classification Name', 'class' => 'form-control', 'maxlength'=>'30']); ?>
     ...
     $('.float').click(function(){
      ...
      $('#frm-insert').on('submit', function(e){
        ...
        if($('#mattype').val() != null)
        {
          if($('#matclassname').val().trim() != "")
          {
            ...
            ///////////////////////////////////////////
            var ddata = {
                strMatClassname: $('#matclassname').val(),
                intMatTypeID: $('#mattype').val()
            }
            $.ajax({
              type : 'post',
              url  : url,
      ...
      $(this).on('click','.edit_supp', function(){
          ...
          $.get(url + '/' + classID + '/edit', function (data) {
                $('#matclassID').val(data.intMatClassID);
                $('#strMaterialClassname').val(data.strMatClassName);
                $('#mattypes > option[value="'+ data.intMatTypeID +'"]').prop('selected', true);
                typeName = data.intMatTypeID;
                selfName = $('#strMaterialClassname').val();
      ...
      $(this).on('submit', function(e){
         ...
         $('span#duplicate2').hide();
          ...
          if($('#mattypes').val() != "")
          {
            ...
            {
              if(selfName == $('#strMaterialClassname').val() && typeName == $('#mattypes').val())
              {
              ...
              else
              {
                var formData = {
                  ...
                  strMatClassname: $('#strMaterialClassname').val(),
                  intMatTypeID: $('#mattypes').val()
                }
                /////////////////start top loading//////////
                NProgress.start();
                ///////////////////////////////////////////
    ...
    //delete get data
     $(this).on('click','.del_supp', function(){
      ...
      $.get(url + '/' + classe + '/edit', function (data) {
            $('#deleteID').text(data.intMatClassID);
            $('#del_classname').text(data.strMatClassName);
