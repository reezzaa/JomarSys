  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
              ...
              <!-- <?php echo $__env->make('layouts.transact.client.company.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
...
<?php if(Session::has('flash_add_success')): ?>
  ...
  <?php endif; ?>
      ...
      <div class="block">
          <?php echo $__env->make('layouts.transact.client.company.table', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          <br>
      </div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('script'); ?>
<a class="float" href="<?php echo e(url('newcompclient/create')); ?>" data-toggle="tooltip" data-placement="left" title="Add Company Client">
