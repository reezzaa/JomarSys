<table id="5cols-datatable" class="table table-vcenter table-striped table-bordered table-hover">
  ...
  <tbody id="project-list">
    ...
    <?php $__currentLoopData = $delitable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
         <td class="text-center"><button class=" btn btn-alt " id="upddel" value="<?php echo e($dt->strDeliveryHID); ?>" data-toggle="tooltip" data-placement="top" data-original-title="Update Delivery Status"><span class="fa fa-spinner fa-2x fa-spin "></span> </button>
         </td>
        <td class="text-center"><?php echo e($dt->strQuoteName); ?></td>
        ...
        <td class="text-center">
            <button class="btn btn-alt btn-info" id="viewdel" value="<?php echo e($dt->strDeliveryHID); ?>" data-toggle="tooltip" data-placement="top" data-original-title="View"><span class="gi gi-eye_open"></span> View</button>
            <button class="btn btn-alt btn-danger" id="deldel" value="<?php echo e($dt->strDeliveryHID); ?>" data-toggle="tooltip" data-placement="top" data-original-title="View"><span class="gi gi-bin"></span> Delete</button>
        </td>
        ...
        <div class="block">
          <div class="block-title themed-background">
            ...
            <h3 class="themed-background" style="color:white;"><strong>Delete Delivery</strong></h3>
             ...
             <?php echo Form::open(['url'=>'delivery','method'=>'PUT','id'=>'frm-del']); ?>
        ...
        <div class="block">
          <div class="block-title themed-background">
            ...
            <h3 class="themed-background" style="color:white;"><strong>Update Delivery</strong></h3>
             ...
             <?php echo Form::open(['url'=>'delivery','method'=>'PUT','id'=>'frm-upd']); ?>
