...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <script src="<?php echo e(asset('js/vendor/jquery.alphanum.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/jquery.mask.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/ckeditor/ckeditor.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/Chart2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/ckeditor/ckeditor.js')); ?>"></script>
    ...
    <style>    
      ...
      .modal-dialog #withScroll {
          overflow-y: initial;
      }
      .modal-body #withScroll}{
        height: 250px;
        overflow-y: auto;
      }
      .my-float{
  ...
  <a href="#" id="to-top"><i class="fa fa-angle-double-up"></i></a>
    ...
    <script src="<?php echo e(asset('js/pages/formsGeneral.js')); ?>"></script>
    <script src="<?php echo e(asset('js/pages/formsValidation.js')); ?>"></script>
    <script src="<?php echo e(asset('js/pages/formsWizard.js')); ?>"></script>
    <script src="<?php echo e(asset('js/pages/tablesDatatables.js')); ?>"></script>
