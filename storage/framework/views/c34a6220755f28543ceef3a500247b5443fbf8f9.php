  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
              ...
              <!-- <?php echo $__env->make('layouts.transact.quote.list.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
...
<h3 class="themed-background" style="color:white"><strong>List of Quotes</strong></h3>
</div>
<!-- Simple Profile Widgets Row -->
<div class="block">
  <?php echo $__env->make('layouts.transact.quote.list.table', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <br>
</div>
<?php $__env->stopSection(); ?>
