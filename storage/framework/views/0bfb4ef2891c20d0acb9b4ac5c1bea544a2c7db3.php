<ul class="sidebar-nav">
    ...
    <li class="active" >
        ...
        <ul>
            ...
            <li class="active">
            <a class="sidebar-nav-submenu active" href="<?php echo e(route('progressmonitoring.index')); ?>"><i class="fa fa-angle-left sidebar-nav-indicator"></i><i class="fa fa-signal sidebar-nav-icon"></i>Progress Monitoring</a>
                 <ul>
                    <li>
                        <a href="<?php echo e(route('indprogressmonitoring.index')); ?>"> Individual Client</a>
                    </li>
                    <li>
                        <a  href="<?php echo e(route('progressmonitoring.index')); ?>" class="active"> Company Client</a>
                    </li>
                </ul>
            </li>
            <li>
