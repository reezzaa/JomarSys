        ...
        <ul>
            <li class="active">
                ...
                <ul>
                    ...
                    <li class="active">
                        <a href="#" class="sidebar-nav-submenu active "><i class="fa fa-angle-left sidebar-nav-indicator"></i>Client List</a>
                        <ul>
                            <li class="active">
                                <a href="<?php echo e(route('newindclient.index')); ?>" class="active">Individual Client</a>
                            </li>
                            <li>
