  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
              ...
              <div class="sidebar-section sidebar-user clearfix">
                  <div class="sidebar-user-avatar">
                      <a href="page_ready_user_profile.html">
                          <img src="<?php echo e(asset('img/placeholders/avatars/avatar2.jpg')); ?>" alt="avatar">
                      </a>
                  </div>
              ...
              <!-- <?php echo $__env->make('layouts.transact.client.addcompany.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
...
<?php $__env->startSection('content'); ?>
      ...
      <ol class="breadcrumb breadcrumb-top">
        ...
        <div class="block">
          ...
          <?php echo Form::open(['url'=>'newcompclient', 'id'=>'save-client','class'=>'form-horizontal form-bordered', 'files' => true]); ?>

              <?php echo $__env->make('layouts.transact.client.addcompany.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo JsValidator::formRequest('App\Http\Requests\CreateCompClientRequest', '#save-client');; ?>
