<ul class="sidebar-nav">
    <li>
        <a href="<?php echo e(route('pm.home')); ?>"><i class="gi gi-display sidebar-nav-icon"></i>Dashboard</a>
    </li>
    ...
    <li >
        <a href="<?php echo e(route('pmutilities.index')); ?>"><i class="fa fa-cogs sidebar-nav-icon"></i>Utilities</a>
    </li>
    <li class="sidebar-header">
     ...
     <li>
                ...
                <ul>
                    <li>
                        <a href="#"><i class="fa fa-angle-left sidebar-nav-icon"></i>Register Client</a>
                    </li>
                    <li>
   ...
   <li>
        ...
        <i class="gi gi-adjust_alt sidebar-nav-icon"></i>Contract Setup</a>
        <ul>
            <li>
                <a href="#"><i class="gi gi-group sidebar-nav-icon"></i>Create Contract</a> 
            </li>
            <li>
                <a href="#"><i class="gi gi-group sidebar-nav-icon"></i>Lists of Contracts</a> 
            </li>
        </ul>
    </li>
    <li >
        <a href="<?php echo e(route('pmutilities.index')); ?>"><i class="gi gi-adjust sidebar-nav-icon"></i>Manage Contract</a>
    </li>
   <!--  <li class="sidebar-header">
