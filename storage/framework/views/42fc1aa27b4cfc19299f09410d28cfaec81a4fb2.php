<div class="form-group">
    ...
    <?php echo Form::select('equiptype', $equiptype, null,  ['id'=>'equiptype','class'=>'form-control', 'placeholder'=>' ']); ?>
...
<div class="form-group">
  ...
  <?php echo Form::text('equipname',null ,['id'=>'equipname','placeholder'=>'Equipment Name', 'class' => 'form-control', 'maxlength'=>'30']); ?>
...
<div class="form-group">
  ...
  <?php echo Form::text('equipmodel',null ,['id'=>'equipmodel','placeholder'=>'Model', 'class' => 'form-control', 'maxlength'=>'30']); ?>
...
<div class="form-group">
  ...
  <?php echo Form::text('equipweight',null ,['id'=>'equipweight','placeholder'=>'Operating Weight', 'class' => 'form-control', 'maxlength'=>'30']); ?>
