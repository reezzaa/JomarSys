...
<script>
   function readByAjax()
  {
      $.ajax({
        type : 'get',
        url  : "<?php echo e(url('readByAjax15')); ?>",
        dataType : 'html',
  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
              ...
              <!-- <?php echo $__env->make('layouts.transact.stockadjustment.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
                ...
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                      <div class="block full container-fluid">
                        ...
                        <?php echo Form::open(['url'=>'stockadjustment', 'method'=>'POST', 'id'=>'frm-insert']); ?>

                         <div class="form-group">
                            <label for="mat">Material <span class="text-danger">*</span>  </label>
                            <?php echo Form::select('mat', $mat, null,  ['id'=>'mat','class'=>'form-control', 'placeholder'=>' ']); ?>
                    ...
                    Duplicate Material
                        ...
                        <div class="form-group">
                          ...
                          <?php echo Form::number('quantity',null ,['id'=>'quantity','placeholder'=>'', 'class' => 'form-control']); ?>
