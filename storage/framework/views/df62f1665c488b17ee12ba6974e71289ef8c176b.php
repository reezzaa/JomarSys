  ...
  function readByAjax()
    {
        $.ajax({
          type : 'get',
          url  : "<?php echo e(url('readByAjax9')); ?>",
          dataType : 'html',
  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
              ...
              <!-- <?php echo $__env->make('layouts.mainte.materialtype.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="block">
            ...
            <?php echo Form::open(['url'=>'materialtype', 'method'=>'POST', 'id'=>'frm-insert']); ?>
                ...
                <?php echo Form::text('mattypename',null ,['id'=>'mattypename','placeholder'=>'Material Type Name', 'class' => 'form-control', 'maxlength'=>'30']); ?>
