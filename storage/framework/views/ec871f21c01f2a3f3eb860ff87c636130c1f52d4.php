    ...
    <li class="active" >
        ...
        <ul>
            <li class="active">
                ...
                <ul>
                    <li class="active">
                        <a href="#" class="sidebar-nav-submenu active"><i class="fa fa-angle-left sidebar-nav-indicator"></i>Add Client</a>
                        <ul>
                            <li class="active">
                                <a href="<?php echo e(route('newindclient.create')); ?>" class="active">Individual Client</a>
                            </li>
                            <li>
