 <table id="groupuom-datatable" class="table table-vcenter table-striped table-condensed table-bordered table-hover">
    ...
    <tbody  id="equiptype-list">
      <?php $__currentLoopData = $groupuom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr id="id<?php echo e($u->intGroupUOMID); ?>">
          ...
          <label class="switch switch-primary">
            <?php if(($u->status)==1): ?>
              ...
              <?php else: ?>
                  <p hidden>0</p> 
              <?php endif; ?>
            <input name="status" id="status" type="checkbox" value="<?php echo e($u->intGroupUOMID); ?>" 
              <?php if(($u->status)==1): ?>
                  <?php echo e("checked"); ?>
          ...
          <td>
            <div class="text-center">
              <button id="edit_supp" class="btn btn-alt btn-warning edit_supp" value = "<?php echo e($u->intGroupUOMID); ?>" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><span class="gi gi-pencil"></span>
              </button>
              <button id="del_supp" class="btn btn-alt btn-danger del_supp" value="<?php echo e($u->intGroupUOMID); ?>" data-toggle="tooltip" data-placement="top" data-original-title="Delete"> <span class="gi gi-bin"></span>
              </button>
          </div>
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="block">
              ...
              <?php echo Form::open(['url'=>'groupuomeasure','method'=>'PUT','id'=>'frm-upd']); ?>

              <div class="form-group">
                <label for="strGroupUOMText">Based UOM Name
                 <span class="text-danger">*</span> </label>
                 <?php echo Form::text('strGroupUOMText' , null,['id'=>'strGroupUOMText', 'class'=>'form-control', 'maxLength'=>'40']); ?>
      ...
      <div class="modal-content">
        <div class="block">
         <div class="block-title themed-background">
           ...
           <?php echo Form::open(['url'=>'groupuomeasure','method'=>'PUT','id'=>'frm-del']); ?>
