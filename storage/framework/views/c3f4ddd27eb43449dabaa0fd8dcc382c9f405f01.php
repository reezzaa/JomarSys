...
<?php $__currentLoopData = $quote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <div class="block full">
    <div class="block-title themed-background">
      <div class="block-options pull-right">
          <a href="" class="btn btn-sm btn-alt btn-primary" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
      </div>
    <h3 class="themed-background" style="color:white;"><strong>Quotation #: <span id="quoteNo"><?php echo e($quote->strQuoteID); ?></span></strong></h3>
    </div>
   <div class="block-section">
      <!-- Company Info -->
          <div class="col-md-offset-1">
            <h5><strong>Client ID: <?php echo e($quote->strCompClientID); ?></strong></h5>
          </div>
          <div class="col-md-offset-1">
            <h5><strong>Client Name: <?php echo e($quote->strCompClientName); ?></strong></h5>
          </div>
          <div class="col-md-offset-1">
            <?php if($quote->strQuoteName != ""): ?>
              <h5><strong>Quote Description: <?php echo e($quote->strQuoteName); ?></strong></h5>
            <?php else: ?>
    ...
    <div id="here"></div>
      <?php echo Form::open(['target' => '_blank','url'=>'pdf/$quote->strQuoteID/quotation/']); ?>

               <input type="hidden" name="id" value="<?php echo e($quote->strQuoteID); ?>">
               <input type="hidden"  id="taxvalue2" name="taxvalue2">
                ...
                <fieldset class="form-group">
                 ...
                 <?php echo Form::submit('Print Quotation',['id'=>'submit','class'=>'btn btn-alt btn-success']); ?>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="block-title themed-background">
              ...
              <h3 class="themed-background" style="color:white;"><strong>Finalize <?php echo e($quote->strQuoteID); ?></strong></h3>
           </div>
              <?php echo Form::open(['url'=>'addquotation', 'method'=>'POST', 'id'=>'form-validation']); ?>

              <?php echo $__env->make('layouts.transact.quote.add.draft.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
              ...
              <input type="hidden" name="id" id="id" value="<?php echo e($quote->strQuoteID); ?>">
    ...
    <div class="modal-content">
        <div class="block">
          ...
          <?php echo Form::open(['url'=>'additional', 'id'=>'save-additional','class'=>'form-horizontal']); ?>
            ...
            <div class="form-group">
              <div class="col-md-offset-9">
              <input type="hidden" name="qdid" value="<?php echo e($quote->strQuoteID); ?>">
