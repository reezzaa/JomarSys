<?php $__env->startSection('head'); ?>
   ...
   <input type="hidden" name="myId2" id="myId2" value="<?php echo e($myId); ?>">
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="block-title themed-background">
              <h3 class="themed-background" style="color:white"><strong>Progress Monitoring</strong></h3>
                  ...
                  <?php $__currentLoopData = $progd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="box box-danger">
                        ...
                        <div class="box-body">
                          ...
                          <h3 class="text-center" ><input type="hidden" id="thisval" class="text-center" style="border: 0;" value="0"> <p id="out"><?php echo e($overall); ?></p></h3>
                          <input type="hidden" id="over" value="<?php echo e($overall); ?>">
                          <br>
                  ...
                  <div class="col-md-6">
                      <table class="table table-vcenter table-striped table-bordered table-hover">
                          ...
                          <td class="text-center"><?php echo e($pd->strQuoteName); ?> </td>
                          </tr>
                          <tr>
                           <th class="text-center"><b> Client </b></th>
                           <td class="text-center"><?php echo e($pd->strCompClientName); ?></td>
                         </tr>
                          <tr>
                             <th class="text-center"><b>Project Location </b></th>
                             <td class="text-center"><?php echo e($pd->strContractLocation); ?></td>
                          </tr>
                          <tr>
                             <th class="text-center"><b> Starting Date </b></th>
                             <td class="text-center"><?php echo e(\Carbon\Carbon::parse($pd->datProjStart)->toFormattedDateString()); ?> </td>
                          </tr>
                         <tr>
                           <th class="text-center"><b> End Date </b></th>
                           <td class="text-center"><?php echo e(\Carbon\Carbon::parse($pd->datProjEnd)->toFormattedDateString()); ?></td>
                         </tr>  
                    </table>
        ...
        <hr>
                ...
                <div class="box">
                  ...
                  <div class="box-tools pull-right">
                            ...
                            <a type="button" href="<?php echo e(route('delivery.create')); ?>"  id="delivery" class="btn btn-lg delivery"><i class="hi hi-send animation-floating"></i>  Add Delivery</a>
                            <a type="button" href="<?php echo e(route('stockadjustment.index')); ?>"  id="stocks" class="btn btn-lg stocks"><i class="fa fa-cubes animation-floating"></i>  Add Stocks</a>
                  </div> <br><br>
              ...
              <div class="modal-content">
                <div class="block">
                 <div class="block-title themed-background">
                  ...
                  <?php echo Form::open(['url'=>route('progressmonitoring.storeOA','classID'),'method'=>'POST','id'=>'frm-upd']); ?>       
