...
<script>
   function readByAjax()
   {
    $.ajax({
      type : 'get',
      url  : "<?php echo e(url('readByAjax17')); ?>",
      dataType : 'html',
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="block full container-fluid">
              ...
              <!-- <?php echo Form::open(['url'=>'userlevel', 'method'=>'POST', 'id'=>'frm-insert']); ?> -->
               <form id="form-validation" action="<?php echo e(url('contractadd')); ?>" method="POST">
