  ...
  function readByAjax()
    {
        $.ajax({
          type : 'get',
          url  : "<?php echo e(url('readByAjax5')); ?>",
          dataType : 'html',
  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
              ...
              <!-- <?php echo $__env->make('layouts.mainte.services.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
            ...
            <div class="modal-dialog modal-md">
              <div class="modal-content">
                <div class="block">
                  ...
                  <?php echo Form::open(['url'=>'serviceOff', 'method'=>'POST', 'id'=>'frm-insert']); ?>
                      ...
                      <div class="form-group">
                        ...
                        <?php echo Form::text('serveName',null ,['id'=>'serveName','placeholder'=>'Service Offered Name', 'class' => 'form-control', 'maxlength'=>'200']); ?>
