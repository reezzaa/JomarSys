  ...
  function readByAjax()
    {
        $.ajax({
          type : 'get',
          url  : "<?php echo e(url('readByAjax7')); ?>",
          dataType : 'html',
  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
            ...
            <!-- <?php echo $__env->make('layouts.mainte.specialization.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="block">
            ...
            <?php echo Form::open(['url'=>'specialization', 'method'=>'POST', 'id'=>'frm-insert']); ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8 col-md-offset-2">
                  <?php echo Form::text('specname',null ,['id'=>'specname','placeholder'=>'Specialization Name', 'class' => 'form-control', 'maxlength'=>'40']); ?>
