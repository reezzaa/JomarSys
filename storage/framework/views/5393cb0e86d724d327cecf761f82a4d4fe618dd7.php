<table id="deliTruck-datatable" class="table table-vcenter table-striped table-condensed table-bordered table-hover">
  <thead>
   ...
   <tbody id="delt-list">
    <?php $__currentLoopData = $delt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
        <td class="text-center">
            <?php echo e($u->strDeliTruckPlateNo); ?>

        </td>
        <td class="text-center">
            <?php echo e($u->strDeliTruckVINNo); ?>

        </td>
        <td class="text-center">
            <?php echo e($u->dblDeliTruckCapacity); ?>

        </td>
        <td class="text-center">
            <?php echo e($u->dblDeliTruckGrossWeight); ?>
          ...
          <label class="switch switch-primary">
            <?php if(($u->status)==1): ?>
              ...
              <?php else: ?>
                  <p hidden>0</p> 
              <?php endif; ?>
            <input name="status" id="status" type="checkbox" value="<?php echo e($u->intDeliTruckID); ?>" 
              <?php if(($u->status)==1): ?>
                  <?php echo e("checked"); ?>
        ...
        <td>
          <div class="text-center">
            <button id="edit_supp" class="btn btn-alt btn-warning edit_supp" value = "<?php echo e($u->intDeliTruckID); ?>" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><span class="gi gi-pencil"></span>
            </button>
            <button id="del_supp" class="btn btn-alt btn-danger del_supp" value="<?php echo e($u->intDeliTruckID); ?>" data-toggle="tooltip" data-placement="top" data-original-title="Delete"> <span class="gi gi-bin"></span>
            </button>
          </div>
      ...
      <div class="modal-content">
        <div class="block">
          <div class="block-title themed-background">
           ...
           <?php echo Form::open(['url'=>'deliverytruck', 'method'=>'PUT', 'id'=>'frm-upd']); ?>

             <div class="form-group">
                <label for="platenos">Plate Number</label>
                <?php echo Form::text('platenos',null ,['id'=>'platenos','placeholder'=>'eg. ABC 1234', 'class' => 'form-control', 'maxlength'=>'8']); ?>
              ...
              <div class="form-group">
                ...
                <?php echo Form::text('vins',null ,['id'=>'vins','placeholder'=>'17 character VIN', 'class' => 'form-control', 'maxlength'=>'17']); ?>
              ...
              <div class="form-group">
                <label for="netcaps">Net Capacity (in Kg)</label>
                 <?php echo Form::text('netcaps',null ,['id'=>'netcaps','placeholder'=>'Net Capacity', 'class' => 'form-control', 'maxlength'=>'10']); ?>
              ...
              <div class="form-group">
                ...
                <?php echo Form::text('weights',null ,['id'=>'weights','placeholder'=>'Gross Weight', 'class' => 'form-control', 'maxlength'=>'10']); ?>
    ...
    <div class="block">
      <div class="block-title themed-background">
          ...
          <h3 class="themed-background" style="color:white;"><strong>Delete Delivery Truck</strong></h3>
            ...
            <?php echo Form::open(['url'=>'deliverytruck','method'=>'PUT','id'=>'frm-del']); ?>
