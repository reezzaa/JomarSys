<ul class="sidebar-nav">
    ...
    <li >
        <a href="<?php echo e(route('utilities.index')); ?>" class="active"><i class="fa fa-cogs sidebar-nav-icon"></i>Utilities</a>
    </li>
    <li>
    ...
    <li  >
        ...
        <ul>
            ...
            <li>
                <a class="sidebar-nav-submenu" href="<?php echo e(route('progressmonitoring.index')); ?>" "><i class="fa fa-angle-left sidebar-nav-indicator"></i>
                <i class="fa fa-signal sidebar-nav-icon"></i>Progress Monitoring</a>
                <ul>
                    <li>
                        <a href="<?php echo e(route('indprogressmonitoring.index')); ?>"> Individual Client</a>
                    </li>
                    <li>
                        <a  href="<?php echo e(route('progressmonitoring.index')); ?>"> Company Client</a>
                    </li>
                </ul>
            </li>
            <li>
    ...
    <li>
        ...
        <ul>
            <li>
                <a  href="<?php echo e(route('clientqueries.index')); ?>" class="active">
            ...
            <li>
                <a href="<?php echo e(route('stockqueries.index')); ?>">
                <i class="fa fa-cubes sidebar-nav-icon"></i>Stock Adjustment</a>
            </li>
            <li>
                <a href="<?php echo e(route('invoicequeries.index')); ?>">
               <i class="gi gi-tags sidebar-nav-icon"></i> Invoices</a>
            </li>
            <li>
                <a  href="<?php echo e(route('deliveryqueries.index')); ?>"><i class="gi gi-group sidebar-nav-icon"></i> Delivery</a>
            </li>
        </ul>
    </li>   
    <li>
        ...
        <ul>
            <li>
                <a href="/soareport"><i class="fa fa-files-o sidebar-nav-icon"></i>Statement of Accounts</a>
            </li>
            <li>
                <a href="/referencesreport"><i class="fa fa-files-o sidebar-nav-icon"></i>References of Billing</a>
            </li>
            <li>
                <a href="/collectionreport"><i class="fa fa-files-o sidebar-nav-icon"></i>Overall Collection</a>
            </li>
            <li>
                <a href="/progressreport"><i class="fa fa-files-o sidebar-nav-icon"></i>Progress Report</a>
            </li>
            <li>
                <a href="/deliveryreport"><i class="fa fa-files-o sidebar-nav-icon"></i>Delivery Report</a>
            </li>
        </ul>
    </li>
</ul>