<table id="serviceOff-datatable" class="table table-vcenter table-striped table-condensed table-bordered table-hover">
  <thead>
   ...
   <tbody id="serve-list">
    <?php $__currentLoopData = $serve; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr id="id<?php echo e($u->intServiceOffID); ?>">
        <td class="text-center">
            <?php echo e($u->strServiceOffName); ?>
          ...
          <label class="switch switch-primary">
            <?php if(($u->status)==1): ?>
              ...
              <?php else: ?>
                  <p hidden>0</p> 
              <?php endif; ?>
            <input name="status" id="status" type="checkbox" value="<?php echo e($u->intServiceOffID); ?>" 
              <?php if(($u->status)==1): ?>
                  <?php echo e("checked"); ?>
        ...
        <td>
          <div class="text-center">
            <button id="edit_supp" class="btn btn-alt btn-warning edit_supp" value = "<?php echo e($u->intServiceOffID); ?>" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><span class="gi gi-pencil"></span>
            </button>
            <button id="del_supp" class="btn btn-alt btn-danger del_supp" value="<?php echo e($u->intServiceOffID); ?>" data-toggle="tooltip" data-placement="top" data-original-title="Delete"> <span class="gi gi-bin"></span>
            </button>
          </div>
        </td>
    </tr>
      ...
      <div class="modal-content">
        <div class="block">
         <div class="block-title themed-background">
            ...
            <?php echo Form::open(['url'=>'serviceOff','method'=>'PUT','id'=>'frm-upd']); ?>

              <div class="form-group hidden">
                 <label for="serveID">Services Offered ID</label>
                <?php echo Form::text('serveID' , null,['id'=>'serveID', 'class'=> 'form-control','readonly'=>'readonly']); ?>

              </div>
              <div class="form-group">
                <label for="strServiceOffName">Service Offered Name <span class="text-danger">*</span> </label>
                <?php echo Form::text('strServiceOffName' , null,['id'=>'strServiceOffName', 'class'=>'form-control', 'maxLength'=>'200']); ?>
      ...
      <div class="modal-content">
        <div class="block">
          <div class="block-title themed-background">
           ...
           <?php echo Form::open(['url'=>'serviceOff','method'=>'PUT','id'=>'frm-del']); ?>
