<?php $__env->startSection('head'); ?>
  <script>
    function readByAjax()
    {
        $.ajax({
          type : 'get',
          url  : "<?php echo e(url('readByAjax3')); ?>",
          dataType : 'html',
  ...
  <div id="sidebar">
      ...
      <div class="sidebar-scroll">
          ...
          <div class="sidebar-content">
              ...
              <!-- <?php echo $__env->make('layouts.mainte.equiptype.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
        ...
        <div class="modal-content">
            <div class="block">
              <div class="block-title themed-background">
               ...
               <?php echo Form::open(['url'=>'equiptype', 'method'=>'POST', 'id'=>'frm-insert']); ?>
                ...
                <div class="form-group">
                  ...
                  <?php echo Form::text('typeName',null ,['id'=>'typeName','placeholder'=>'Equipment Type Name', 'class' => 'form-control', 'maxlength'=>'40']); ?>
